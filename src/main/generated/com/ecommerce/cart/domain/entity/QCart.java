...
public class QCart extends EntityPathBase<Cart> {
    ...
    private static final long serialVersionUID = -1910996236L;
    ...
    public final com.ecommerce.member.domain.entity.QMember member;
    ...
    public QCart(Class<? extends Cart> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new com.ecommerce.member.domain.entity.QMember(forProperty("member")) : null;
    }
